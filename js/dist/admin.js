...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('fof/impersonate', function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_PermissionGrid__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'moderateItems', function (items) {
    items.add('fof-impersonate-login', {
      icon: 'fas fa-id-card',
      label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('fof-impersonate.admin.permissions.login'),
